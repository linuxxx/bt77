...
if [ "${publicFileMd5}" != "${md5check}"  ]; then
	wget -O Tpublic.sh https://gitee.com/dayu777/btpanel-v7.7.0/raw/main/install/public.sh -T 20;
...
wget -T 5 -O /tmp/panel.zip https://gitee.com/dayu777/btpanel-v7.7.0/raw/main/install/src/LinuxPanel-7.7.0.zip
...
if [ "${check_bt}" = "" ];then
	rm -f /etc/init.d/bt
	wget -O /etc/init.d/bt https://gitee.com/dayu777/btpanel-v7.7.0/raw/main/install/src/bt6.init -T 20
