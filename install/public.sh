...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://gitee.com/dayu777/btpanel-v7.7.0/raw/main/install/update6_en.sh|bash
	else
		curl https://gitee.com/dayu777/btpanel-v7.7.0/raw/main/install/update6.sh|bash
	fi
