...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/linuxxx/bt77/refs/heads/main/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/linuxxx/bt77/refs/heads/main/install/update6.sh|bash
	fi
